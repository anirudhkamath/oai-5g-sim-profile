...
xterm -e bash -c "cd /opt/openairinterface5g/cmake_targets; sudo ./ran_build/build/nr-uesoftmodem -r 106 --numerology 1 --band 78 -C 3619200000 --sa --nokrnmod -O /local/repository/etc/ue.conf -d > ~/ue_logs_$1 2>&1 " &
